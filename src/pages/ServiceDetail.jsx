                        ...
                        <div className="bg-charcoal border border-gold/10 p-10 md:p-14 relative group">
                            ...
                            <div className="flex gap-2 mb-12">
                                <button
                                    ...
                                    className={`flex-1 py-4 text-[9px] uppercase font-bold tracking-[0.2em] transition-all duration-700 border ${selectedType === 'request' ? 'bg-gold text-rich-black border-gold' : 'border-white/5 text-gray-500 hover:border-gold/30'}`}
                                >
                                    {t('service_detail.acquire')}
                                </button>
                                <button
                                    onClick={() => setSelectedType('partner')}
                                    className={`flex-1 py-4 text-[9px] uppercase font-bold tracking-[0.2em] transition-all duration-700 border ${selectedType === 'partner' ? 'bg-gold text-rich-black border-gold' : 'border-white/5 text-gray-500 hover:border-gold/30'}`}
                                >
