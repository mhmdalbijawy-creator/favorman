                            ...
                            >
                                ...
                                <div className="space-y-4">
                                    ...
                                    <select name="expertise" className="w-full bg-transparent border-b border-white/10 py-3 text-white focus:outline-none focus:border-gold transition-colors font-light appearance-none">
                                        <option value="logistics" className="bg-charcoal text-white">Global Logistics</option>
                                        <option value="energy" className="bg-charcoal text-white">Energy & Resources</option>
                                        <option value="consultancy" className="bg-charcoal text-white">Strategic Consultancy</option>
                                        <option value="tech" className="bg-charcoal text-white">Technology & AI</option>
                                        <option value="other" className="bg-charcoal text-white">Other Specialization</option>
                                    </select>
                                </div>
                                ...
                                <button
                                    ...
                                    className="group relative w-full py-6 bg-gold text-rich-black uppercase font-bold tracking-[0.4em] text-[11px] overflow-hidden transition-all duration-700 hover:scale-[1.02] active:scale-95 shadow-xl hover:shadow-gold/20"
                                >
